...
バグ報告と PR を歓迎します。`djrobstep/migra` で報告された問題を修正する場合は、PR にそのイシュー番号を記載してください — コミュニティが最も修正を必要としているものを追跡するのに役立ちます。
...
MigraDiff は MIT ライセンスです。MigraDiff をベースにした商用製品を構築されている場合は、ぜひお知らせください — enterprise@Lateos.ai
