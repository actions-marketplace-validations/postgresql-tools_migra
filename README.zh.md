...
欢迎提交错误报告和 PR。如果您在修复 `djrobstep/migra` 中上游报告的问题，请在您的 PR 中引用该问题编号 —— 这有助于我们追踪社区最需要修复的内容。
...
MigraDiff 使用 MIT 许可证。如果您正在 MigraDiff 之上构建商业产品，我们很乐意听取您的意见 —— enterprise@Lateos.ai
