...
תודה על התעניינותכם בפרויקט זה. שימו לב כי איננו מקבלים כרגע תרומות קוד חיצוניות, בקשת משיכה (pull requests), תיקוני באגים או הצעות תכונה.

כל בקשת משיכה שתיפתח תיסגר אוטומטית ללא סקירה.
